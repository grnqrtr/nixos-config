...

{
  ...
  services.cinnamon.apps.enable = false; # Disable default applications
  ...
  # Chromebook Keyboard Setup
  # https://trail-cheese-9c7.notion.site/NixOS-Chromebook-Keyboard-Shortcuts-104c72bb4e638089b537f8784ef61c7d
  ...
  users.users.naomi = {
    ...
    # Add some default programs back.
    cinnamon.xreader
    cinnamon.xviewer
    xed
  ...
  services.displayManager.autoLogin.user = "naomi";
